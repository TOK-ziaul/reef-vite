...
const translations = {
  en: {
    ...
    coffeeHeroTitle: "Sector of Development, Production, Manufacturing, and Marketing of Saudi Coffee",
    coffeeIntroP1: "The coffee and coffee bean sector represents one of the strategic pillars of the 'Reef Saudi Arabia' Program, as it is considered a high-value cash crop and a key component in supporting food security and strengthening the rural economy. The program aims to establish an integrated value chain that begins with cultivation and ends with marketing, with a focus on improving the quality of Saudi coffee and enabling small farmers to enter local and global markets with confidence and sustainability.",
    coffeeIntroP2: "The program contributes to increasing self-sufficiency in coffee and reducing reliance on imports by supporting farmers with modern technologies and building specialized infrastructure that includes nurseries, factories, and agricultural extension service centers. In addition, it creates quality job opportunities for youth in production regions and improves the income of small producers.",
    
    // Coffee Sector Objectives
    coffeeObj1: "Introducing and promoting coffee as a cash crop within the agricultural crop structure of the Kingdom.",
    coffeeObj2: "Increasing the level of self-sufficiency and reducing coffee imports.",
    coffeeObj3: "Raising the income of small producers and improving their livelihoods.",
    ...
    coffeeAction3: "Introducing modern harvesting techniques and post-harvest technologies to reduce losses.",
    coffeeAction4: "Facilitating access to agricultural credit and financing.",
    coffeeAction5: "Establishing advisory service centers and scientific research facilities.",
    coffeeAction6: "Providing direct financial support to small producers.",
    coffeeAction7: "Forming cooperative associations and specialized marketing centers.",
    coffeeAction8: "Building rainwater harvesting facilities and ensuring irrigation water supply.",
    coffeeAction9: "Training and developing technical skills and human resources.",
    coffeeAction10: "Applying plant quarantine systems to protect local production.",
    
    // Coffee Stats Section
    coffeeStatsTitle: "Figures and Indicators",
    coffeeStatsSubtitle: "The figures for the period 2020–2024 indicate accelerated growth in Saudi coffee production.",
    ...
    coffeeMen: "Men",
    coffeeWomen: "Women",
    coffeeGeographicalDistribution: "Geographical Distribution of Beneficiaries",
    coffeeProductionGrowth: "Production Growth",
    coffeeProductionSubtitle: "Annual production in tons",
    coffeeTons: "tons",
    coffeeGrowth: "Growth",
    coffeeTarget: "Target",
    coffeeGrowthNote: "The figures reflect significant growth in Saudi coffee production, with ambitious targets for 2026.",
    ...
    coffeeProjectsIntro: "The \"Reef Saudi Arabia\" Program is implementing a package of strategic projects in the Saudi coffee sector with the aim of developing the value chain from cultivation through processing and marketing, and enhancing the competitiveness of Saudi coffee locally and globally.",
    coffeeKeyProjects: "Key Sector Projects",
    
    // Feasibility
    coffeeFeasibilityTitle: "Technical and Economic Feasibility of the Projects",
    coffeeFeasibilityIntro: "The \"Reef Saudi Arabia\" Program in the coffee sector focuses on achieving integrated development that includes:",
    coffeeFeasibility1: "Training farmers in modern cultivation and harvesting techniques",
    coffeeFeasibility2: "Establishing demonstration fields and specialized nurseries",
    coffeeFeasibility3: "Harvesting rainwater to provide sustainable irrigation sources",
    coffeeFeasibility4: "Expanding cultivated areas and increasing productivity",
    coffeeFeasibility5: "Cultivating coffee on mountain terraces and removing harmful plants",
    coffeeFeasibility6: "Supporting environmental sustainability and strengthening the local economy",
    coffeeFeasibility7: "Reducing dependence on imports and enhancing competitiveness",
    coffeeFeasibility8: "Planning access to global markets",

    // Objectives
    coffeeObjectivesTitle: "Project Objectives",
    coffeeObjective1: "Improving the quality of Saudi coffee using the latest production and processing technologies",
    coffeeObjective2: "Increasing the number of seedlings and expanding agricultural areas",
    coffeeObjective3: "Establishing model farms and improving water resource management",
    coffeeObjective4: "Creating demonstration fields to rationalize water consumption",
    coffeeObjective5: "Utilizing agricultural land efficiently and sustainably",
    coffeeObjective6: "Developing agricultural practices compatible with climate and soil conditions",
    ...
    fruitsHeroTitle: "Sector of Fruit Development, Production, Processing, and Marketing",
    fruitsIntro1: "The fruit sector in the Reef Saudi Arabia Program aims to support the development, production, and marketing of fruits with comparative advantage and high value by improving production and marketing processes, enhancing value chain efficiency, and adding economic value through collection, processing, and marketing. This contributes to increasing farmers' income and creating sustainable development opportunities for rural communities amid growing local and global demand for fruit products.",
    fruitsIntro2: "The program focuses on building an integrated system that begins with improving agricultural practices and ends with preparing marketing outlets and supply chains, ensuring product quality, reducing losses, and enhancing competitiveness in the markets.",
    fruitsObj1: "Support the production and marketing of fruits with comparative advantage and high value",
    fruitsObj2: "Increase farmers' income through improved production and marketing",
    fruitsObj3: "Add high value and create job opportunities through collection, processing, and marketing",
    fruitsObj4: "Create development opportunities for areas with high demand for fruit products",
    fruitsObj5: "Stimulate rural development, increase community income, and improve their livelihoods",
    fruitsWorkAxis1: "Implementing good agricultural practices including modern farming operations",
    fruitsWorkAxis2: "Establishing productive, marketing, and processing cooperatives",
    fruitsWorkAxis3: "Building small dams and barriers to harvest rainwater and tanks to provide irrigation water",
    fruitsWorkAxis4: "Developing and disseminating the use of modern irrigation systems",
    fruitsWorkAxis5: "Establishing nurseries for subtropical fruits",
    fruitsWorkAxis6: "Developing fruit drying and storage systems and introducing mechanized harvesting and post-harvest technologies to reduce losses",
    fruitsWorkAxis7: "Establishing model farms to promote and develop fruit cultivation",
    fruitsWorkAxis8: "Training staff of the Ministry of Environment, Water and Agriculture in subtropical fruit sectors",
    fruitsWorkAxis9: "Facilitating access to financial credit through the Agricultural Development Fund",
    fruitsWorkAxis10: "Developing the skills and capacities of small agricultural producers",
    fruitsWorkAxis11: "Establishing centers to provide extension services, research, and applied studies",
    ...
    fruitsTarget: "(Target)",
    fruitsStatsNote: "*Figures for the period 2020 - 2024 showing accelerated growth in fruit production within supported areas.",
    ...
    fruitsProjectsIntro: "The 'Reef Saudi Arabia' Program implements an integrated system of projects in the fruit sector, aimed at developing production, improving quality, and enhancing value chains from farm to market, contributing to raising self-sufficiency and supporting farmers' income.",
    fruitsProjectsHighlights: "Key Sector Projects",
    fruitsProject1: "Establishment and equipping of marketing service centers for agricultural products",
    fruitsProject2: "Establishment of fruit production and marketing development center",
    fruitsProject3: "Operation and maintenance of the research unit for agriculture with renewable water in Wadi Bin Hashbal",
    fruitsProject4: "Supply of agricultural equipment and materials for the research unit project in Wadi Bin Hashbal",
    fruitsProject5: "Installation of materials for nurseries at the Horticulture Research Center in Najran",
    fruitsProject6: "Laboratory equipment for the plant disease and soil control research unit in Jazan",
    fruitsProject7: "Installation of equipment and materials for the Central Plant Wealth Laboratory in Riyadh",
    fruitsProject8: "Installation of equipment for the Plant Disease and Chemical Pollutants Control Center in Riyadh",
    fruitsProject9: "Application of sustainable irrigation systems and modern agricultural techniques for small fruit crop farmers",
    fruitsFeasibilityTitle: "Technical and Economic Feasibility of Projects",
    fruitsFeasibilityIntro: "Fruit sector projects contribute to achieving a set of strategic gains, most notably:",
    fruitsFeasibility1: "Extending product shelf life through cooling and preservation processes before distribution",
    fruitsFeasibility2: "Improving cleaning and packaging processes and ensuring products comply with health standards",
    fruitsFeasibility3: "Supporting farmers with quality projects to increase agricultural land holdings",
    fruitsFeasibility4: "Raising the self-sufficiency rate in fruit crops",
    fruitsFeasibility5: "Equipping advanced cooling and storage units to enhance product quality",
    fruitsFeasibility6: "Developing, maintaining, and pruning trees, and protecting palm trees and fruit-bearing trees",
    fruitsFeasibility7: "Cleaning agricultural fields from waste and improving the production environment",
    fruitsFeasibility8: "Increasing awareness and building capacities through farmer training",
    fruitsFeasibility9: "Transferring knowledge and developing agricultural practices using modern technologies",
    fruitsFeasibility10: "Creating sustainable marketing solutions and providing direct sales outlets",
    fruitsFeasibility11: "Reducing supply chains between producer and consumer to raise marketing efficiency",
    fruitsProjectObjectivesTitle: "Project Objectives",
    fruitsProjectObjective1: "Establishing integrated agricultural and marketing service centers for fruits including sorting, cleaning, packaging, wrapping, and transportation",
    fruitsProjectObjective2: "Training farmers, specialists, and stakeholders in extension fields on modern agricultural practices",
    fruitsProjectObjective3: "Operating and maintaining research units and providing necessary equipment and devices",
    fruitsKeyWorks2024Title: "Key Work Accomplished in 2024",
    fruitsWork1Title: "Establishing New Nurseries",
    fruitsWork1Desc: "Two locations were selected to establish cooperative fruit nurseries at the Agricultural Association in Taif and the Agricultural Marketing Association in Jazan, with an estimated capacity of 15,000 seedlings per nursery. Work is underway to prepare the files and establish the two nurseries to serve farmers.",
    ...
    fruitsWork3Desc: "Six imported varieties of grapes, figs, apricots, and almonds were described in the extension field in Baljurashi in cooperation with the Seed and Seedling Center in Al-Baha, with the aim of determining morphological and production specifications, measuring variety compatibility with the regional climate, and propagating suitable varieties with high productivity.",
    fruitsWork4Title: "Developing Women's Agricultural Entrepreneurship",
    fruitsWork4Duration: "Implementation of a 3-month training program that included:",
    fruitsWork4Point1: "Selecting and training 15 female agricultural entrepreneurs on establishing and operating private agricultural nurseries in Baljurashi city, Al-Baha region",
    fruitsWork4Point2: "Participation of 12 trainees in the first course for 3 days",
    fruitsWork4Point3: "Participation of 15 trainees in the second course for 2 days",
    fruitsWork4Point4: "Continuous practical field training on establishing and operating nurseries",
    fruitsWork4Point5: "Developing processing and manufacturing skills, especially for pomegranate and manufacturing products:",
    ...
    fruitsWork5Point1: "Conducting a survey to diagnose pests and diseases of figs, grapes, and pomegranates",
    fruitsWork5Point2: "Preparing integrated management programs to combat powdery mildew, fruit flies, nematodes, and pomegranate moths",
    fruitsWork5Point3: "Programs will be submitted and approved in cooperation with Weqaa Center to agree on implementation mechanisms and begin application.",
    ...
    livestockIntro2: "The program seeks to bring about a qualitative shift in traditional livestock production systems through the introduction of modern technologies, infrastructure development, and enabling breeders to benefit from veterinary, advisory, and financing services, which contributes to raising productivity, improving the quality of livestock products, and creating sustainable economic opportunities in the rural sector.",
    livestockMainGoalsTitle: "Main Objectives of the Sector:",
    livestockGoal1: "Develop sheep, goats, and camels in desert areas to regulate the optimal use of natural resources in these marginal regions.",
    livestockGoal2: "Improve productivity and increase household income for small breeders and enhance their livelihoods.",
    livestockGoal3: "Develop traditional livestock production systems in a way that maintains their role in enhancing food security.",
    livestockGoal4: "Develop goat and camel milk production and processing as a special nutritional source for children and women in products that meet market needs.",
    livestockWorkAxesTitle: "Work Axes in the Livestock Sector:",
    livestockAxis1: "Establishing a genetic assets bank to develop local breeds for small livestock breeders.",
    livestockAxis2: "Developing applied research and genetic improvement of local and hybrid breeds to increase their production of lambs and milk.",
    livestockAxis3: "Providing support to establish or strengthen agricultural cooperative associations",
    livestockAxis4: "Adopting and disseminating modern technologies in breeding, production systems, appropriate care, balanced nutrition, and marketing their products to improve their income.",
    livestockAxis5: "Establishing a financing policy to develop and support small breeders to modify the breeding and production pattern in the rural sector.",
    livestockAxis6: "Improving veterinary guidance and developing care systems, veterinary services, and feeding for sheep, goat, and camel herds in desert areas.",
    livestockAxis7: "Establishing an advanced system for trading and marketing rural livestock sector products.",
    livestockAxis8: "Managing livestock herd grazing to expand the carrying capacity of pastures.",
    livestockAxis9: "Cultivating drought-resistant fodder types and varieties as livestock feed, and rehabilitating pastures by protecting fodder reserves in dry seasons.",
    livestockAxis10: "Implementing veterinary quarantine systems.",
    livestockAxis11: "Preparing a sector database that includes counting their numbers, recording all their data and numbering them to enable their follow-up, study and evaluation.",
    livestockObj1: "Increase livestock productivity and improve breed quality through modern breeding programs",
    livestockObj2: "Enhance the quality of dairy products and ensure compliance with health and safety standards",
    livestockObj3: "Provide comprehensive veterinary care and preventive health services for livestock",
    livestockObj4: "Develop marketing channels and create stable income opportunities for small breeders",
    livestockAction1Title: "Breed Improvement Programs",
    livestockAction1Desc: "Implementing selective breeding programs and introducing improved breeds to enhance productivity and disease resistance",
    livestockAction2Title: "Veterinary Care Services",
    livestockAction2Desc: "Providing comprehensive veterinary care including vaccinations, treatment, and regular health monitoring",
    livestockAction3Title: "Feed Quality Enhancement",
    livestockAction3Desc: "Developing animal feed quality and ensuring nutritional balance to maximize production",
    livestockAction4Title: "Dairy Production Support",
    livestockAction4Desc: "Supporting dairy farmers with modern equipment, training, and quality control systems",
    livestockAction5Title: "Marketing and Distribution",
    livestockAction5Desc: "Creating marketing channels and connecting breeders with local and regional markets",
    livestockAction6Title: "Training and Capacity Building",
    livestockAction6Desc: "Providing technical training on modern livestock management practices and business skills",
    livestockProject1Title: "Small Livestock Breeder Support Program",
    livestockProject1Desc: "Comprehensive support program providing financing, training, and technical assistance to small-scale livestock breeders",
    livestockProject2Title: "Dairy Quality Improvement Initiative",
    livestockProject2Desc: "Initiative focused on enhancing dairy production quality through modern equipment and quality control systems",
    livestockProject3Title: "Veterinary Mobile Clinics",
    livestockProject3Desc: "Mobile veterinary services reaching remote rural areas to provide healthcare for livestock",
    livestockProject4Title: "Feed Production Centers",
    livestockProject4Desc: "Establishing local feed production centers to ensure quality nutrition at affordable prices",
    ...
    establishmentImageCaption: "Empowering rural communities across the Kingdom",
    
    // Vision 2030 Section
    vision2030SectionTitle: "Reef Saudi Arabia & Vision 2030",
    vision2030Point1Title: "Economic Diversification",
    vision2030Point1Text: "Contributing to diversifying the national economy by developing agricultural sectors and supporting rural entrepreneurship.",
    vision2030Point2Title: "Food Security",
    vision2030Point2Text: "Strengthening the Kingdom's food security through sustainable agricultural practices and increased local production.",
    vision2030Point3Title: "Rural Development",
    vision2030Point3Text: "Improving quality of life in rural areas through infrastructure, services, and economic opportunities.",
    vision2030Point4Title: "Job Creation",
    vision2030Point4Text: "Creating sustainable employment opportunities for Saudi citizens in agricultural and related sectors.",
    vision2030Point5Title: "Innovation & Technology",
    vision2030Point5Text: "Adopting modern agricultural technologies and innovative farming methods to enhance productivity.",
    vision2030Point6Title: "Environmental Sustainability",
    vision2030Point6Text: "Promoting sustainable farming practices that preserve natural resources and protect the environment.",
    vision2030Point7Title: "Cultural Preservation",
    vision2030Point7Text: "Maintaining traditional agricultural heritage while modernizing production methods and techniques.",
    vision2030Point8Title: "Global Competitiveness",
    vision2030Point8Text: "Positioning Saudi agricultural products competitively in regional and international markets.",
    vision2030CTA1: "Explore Strategic Objectives",
    vision2030CTA2: "Discover Our Sectors",
    
    // Vision & Mission Section
    visionMissionVisionTitle: "Our Vision",
    visionMissionVisionText: "To be the leading force in sustainable agricultural rural development in the Kingdom of Saudi Arabia by 2030, creating thriving rural communities with enhanced living standards and economic prosperity.",
    visionMissionMissionTitle: "Our Mission",
    visionMissionMissionText: "Empowering small farmers and productive families through integrated support programs, modern agricultural technologies, and sustainable practices that ensure food security and economic growth.",
    
    // Strategic Objectives
    strategicObj1Title: "Economic Empowerment",
    strategicObj1Text: "Supporting small farmers and rural families to establish sustainable income sources through targeted financial assistance, training, and market access.",
    strategicObj2Title: "Agricultural Productivity",
    strategicObj2Text: "Enhancing agricultural output and efficiency through modern farming techniques, technology adoption, and infrastructure development.",
    strategicObj3Title: "Technical Development",
    strategicObj3Text: "Building technical capacity through comprehensive training programs, workshops, and knowledge transfer initiatives across all agricultural sectors.",
    strategicObj4Title: "Innovation & Technology",
    strategicObj4Text: "Integrating cutting-edge agricultural technologies and digital solutions to improve production quality and operational efficiency.",
    strategicObj5Title: "Environmental Sustainability",
    strategicObj5Text: "Promoting sustainable farming practices that preserve natural resources, protect biodiversity, and ensure long-term environmental health.",
    strategicObj6Title: "Market Access & Export",
    strategicObj6Text: "Facilitating market access for local products and enhancing export capabilities to reach regional and international markets.",
    strategicObj7Title: "Food Security",
    strategicObj7Text: "Contributing to the Kingdom's food security by increasing local production of strategic crops and reducing import dependency.",
    strategicObj8Title: "Quality of Life",
    strategicObj8Text: "Improving living standards in rural communities through infrastructure development, essential services, and economic opportunities.",
    
    // Organizational Structure
    orgStructureTitle: "Organizational Structure",
    orgStructureParagraph1: "The Reef Saudi Arabia Program operates under the Ministry of Environment, Water, and Agriculture with a clear organizational structure designed to ensure effective implementation and accountability. The structure includes strategic oversight committees, operational management teams, and specialized technical units working in coordination to achieve program objectives.",
    ...
    partnersIntro: "Reef Saudi Arabia works in close partnership with government entities, development organizations, research institutions, and private sector companies to deliver comprehensive support and achieve sustainable rural development across the Kingdom.",
    ...
    partnersPrivate1: "Saudi Agricultural & Livestock Investment Company (SALIC)",
    partnersPrivate2: "National Agricultural Development Company (NADEC)",
    partnersPrivate3: "Almarai Company",
    partnersPrivate4: "Saudi Company for Agricultural Investment & Animal Production",
    ...
    achievementsFiguresSubtitle: "Figures That Reflect a Thriving Rural Reality",
    achievementsTotalBeneficiaries: "Total Number of Beneficiaries Since Program Launch in 2020",
    ...
    achievementsFinancialSupport: "Total Amount of Financial Support Since Program Launch",
    achievementsTrainingCourses: "Training Courses Provided Under the Program",
    achievementsTrainingBeneficiaries: "Number of Beneficiaries from Training Courses",
    achievementsProjects: "Number of Projects Under Construction",
    achievementsProjectsValue: "Value of Program Projects",
    achievementsFreelanceCerts: "Number of Freelance Work Certificates Issued Through Reef Saudi Arabia",
    achievementsRuralProducts: "Number of Products (Comparative Advantage Products) Supported by Reef Saudi Arabia Program",
    ...
    achievementsHighlight1: "Empowered over 87,000 beneficiaries across all regions of Saudi Arabia with comprehensive agricultural and rural development support programs",
    achievementsHighlight2: "Conducted 129 specialized training courses covering modern agricultural techniques, business management, and sustainable farming practices",
    achievementsHighlight3: "Established 64 rural product brands connecting local producers to national and international markets with quality certifications",
    achievementsHighlight4: "Implemented innovative smart farming technologies across 105+ projects, integrating IoT sensors, precision agriculture, and data analytics",
    achievementsHighlight5: "Supported women entrepreneurs through specialized programs in honey production, handicrafts, and agricultural value-added products",
    achievementsHighlight6: "Achieved significant environmental impact through sustainable farming initiatives and distribution of over 15.5 million seedlings",
    achievementsHighlight7: "Organized national agricultural forums and exhibitions attracting thousands of participants and showcasing rural development success stories",
    achievementsAwardsTitle: "International Recognition & Awards",
    achievementsAward1Title: "United Nations Public Service Award",
    achievementsAward1Desc: "Recognized for excellence in public service delivery and innovative rural development programs",
    achievementsAward2Title: "Princess Royal Training Award",
    achievementsAward2Desc: "Honored for outstanding achievements in training and human capital development",
    achievementsAward3Title: "Arab Innovation Award",
    achievementsAward3Desc: "Awarded for implementing cutting-edge agricultural technologies and smart farming solutions",
    achievementsAward4Title: "Digital Transformation Excellence",
    achievementsAward4Desc: "Recognized for pioneering digital solutions in agricultural development and beneficiary services",
    achievementsAward5Title: "Hail Regional Development Award",
    achievementsAward5Desc: "Celebrated for transformative impact on rural communities in the Hail region",
    achievementsCertificationsTitle: "Quality Certifications & Standards",
    achievementsISOTitle: "ISO 9001:2015 Certified",
    achievementsISODesc: "Our program operations are certified to international quality management standards, ensuring excellence in service delivery, continuous improvement, and stakeholder satisfaction across all our initiatives.",
    achievementsGuinnessTitle: "Guinness World Record",
    achievementsGuinnessDesc: "Achieved a Guinness World Record for the largest seedling distribution campaign, planting over 15.5 million trees in rural areas within a single initiative year.",
    achievementsGuinness1: "Achieved a Guinness World Record for the largest seedling distribution campaign, planting over 15.5 million trees in rural areas within a single initiative year.",
    achievementsISO1Title: "ISO 9001:2015 Quality Management",
    achievementsISO1Desc: "Certified for excellence in quality management systems, ensuring consistent service delivery and continuous improvement.",
    achievementsISO2Title: "ISO 22301 Business Continuity",
    achievementsISO2Desc: "Certified for business continuity management, ensuring resilience and sustainable operations during disruptions.",
    achievementsISO3Title: "ISO 56002 Innovation Management",
    achievementsISO3Desc: "Certified for innovation management systems, fostering creativity and driving continuous innovation in agricultural development.",
    achievementsISOSubtitle: "Committed to international standards of excellence and quality",
    achievementsAwardsSubtitle: "Recognized globally for excellence in sustainable rural development",
    achievementsIndicatorsSubtitle: "Measuring the positive economic transformation in rural communities",
    achievementsAward6Title: "Hail Regional Development Award",
    achievementsAward6Desc: "Celebrated for transformative impact on rural communities in the Hail region",
    achievementsCTA1: "View Full Report",
    achievementsCTA2: "Download Statistics",
    
    // Beekeeping Sector
    beekeepingDevelopmentHoneyProduction: "Beekeeping Development & Honey Production",
    beekeepingIntro1: "The Beekeeping Development and Honey Production Initiative represents one of the most vital pillars of the Reef Saudi Arabia Program, aiming to develop and strengthen the beekeeping sector in the Kingdom through comprehensive and innovative support programs.",
    beekeepingIntro2: "This initiative focuses on enhancing honey production quality, supporting local beekeepers, and developing apiculture practices using modern scientific methods that align with international standards while preserving traditional Saudi beekeeping heritage.",
    beekeepingIntro3: "Through strategic partnerships and integrated support programs, we work to transform beekeeping from traditional individual practices into a sustainable economic sector that contributes to food security and rural economic development.",
    honeyWork1: "Supporting beekeepers with modern hives and sustainable beekeeping equipment",
    honeyWork2: "Developing beekeeping techniques through training and technical support programs",
    honeyWork3: "Promoting innovation in honey production and bee product development",
    honeyWork4: "Establishing logistics systems for collecting and distributing honey products",
    honeyWork5: "Building partnerships with research centers and academic institutions",
    honeyWork6: "Providing financial support and soft loans for beekeeping projects",
    honeyWork7: "Creating cooperative societies for beekeepers and producers",
    honeyWork8: "Planting bee-friendly flora and establishing natural bee pastures",
    honeyWork9: "Preserving local bee breeds and biodiversity conservation",
    honeyWork10: "Organizing training courses in modern apiculture and honey quality standards",
    ...
    copyrightFull: "All intellectual property rights reserved for Reef Saudi Arabia Program",
    copyrightSupervision: "Under the supervision of the Ministry of Environment, Water and Agriculture",
    ...
    rosesObj3:
      "Exporting rose products to Gulf countries and Europe.",
    rosesObj4:
      "Creating numerous job opportunities, especially for women.",
    ...
    rosesAction3:
      "Establishing distillation facilities.",
    rosesAction4:
    ...
    productionGrowthDesc: "Figures for the period 2020–2024 indicate accelerated growth in the production of roses and aromatic plants.",
    ...
    projectsIntro: "The \"Reef Saudi Arabia\" Program is implementing a package of specialized projects in the rose and aromatic plants sector, aiming to increase local production, strengthen value chains, and develop industries related to perfumes and plant extracts across various regions of the Kingdom.",
    keySectorProjects: "Key Sector Projects",
    project1: "Establishing specialized cities for roses and aromatic plants in Jazan region.",
    project2: "Establishing specialized nurseries for roses and aromatic plants in Jazan region.",
    project3: "Establishing a factory for extracting essential oils from roses and aromatic plants, along with nurseries, in Abu Arish Governorate (National Park).",
    project4: "Providing advisory support to implement field schools using artificial intelligence applications.",
    project5: "Developing a database for rose, jasmine, camphor, and honey farmers to monitor labor force needs.",
    project6: "Supplying laboratory equipment and tools for water and soil analysis in several regions of the Kingdom.",
    project7: "Establishing the Rose Center in Taif city.",
    project8: "Establishing and equipping a tissue culture laboratory to produce high-quality roses in Riyadh region.",
    project9: "Supplying greenhouses and agricultural shade structures and establishing irrigation networks for rose and aromatic plant cities in Jazan.",
    project10: "Rehabilitating the tissue culture laboratory to produce high-quality roses in Riyadh.",
    project11: "Applying sustainable irrigation systems and modern agricultural technologies for small rose farmers in Taif Governorate.",
    project12: "Supplying mobile clinics to diagnose diseases and pests of roses and medicinal and aromatic plants.",
    project13: "Supplying equipment to technical extension units for photography and video editing for ministry branches in different regions.",
    technicalEconomicFeasibility: "Technical and Economic Feasibility of the Projects",
    feasibilityIntro: "Projects in the rose and aromatic plants sector contribute to achieving several strategic gains, including:",
    feasibility1: "Increasing local rose production and reducing dependence on imports.",
    feasibility2: "Enhancing local revenues and creating new job opportunities for farmers.",
    feasibility3: "Promoting agricultural heritage related to rose cultivation as part of regional cultural identity.",
    feasibility4: "Supporting sustainable agricultural practices in managing water and soil resources.",
    feasibility5: "Achieving a balance between economic growth and environmental conservation.",
    feasibility6: "Preserving biodiversity of aromatic plants.",
    feasibility7: "Encouraging small farmers to adopt best agricultural practices.",
    feasibility8: "Diversifying aromatic crops to achieve sustainable income.",
    feasibility9: "Reducing logistical costs by localizing industries through distillation and processing facilities.",
    feasibility10: "Creating diverse plant environments that support environmental sustainability.",
    projectObjectives: "Project Objectives",
    projectObjectivesIntro: "The rose and aromatic plants sector projects under the \"Reef Saudi Arabia\" Program focus on achieving the following objectives:",
    objective1: "Increasing the Kingdom's rose production to meet local market demand and reduce reliance on imports.",
    objective2: "Establishing specialized facilities for extracting rose oil and rose water.",
    objective3: "Supporting and developing the local perfume industry.",
    objective4: "Enabling the export of rose and aromatic plant products to Gulf and global markets, contributing to the objectives of Saudi Vision 2030.",

    keyImplementedActivities: "Key Implemented Activities in the Rose and Aromatic Plants Sector",
    
    activity1Title: "Establishment of Demonstration Fields",
    activity1Desc: "A total of 12 demonstration fields were implemented to develop rose and jasmine cultivation in the Taif and Jazan regions, applying the latest practices in pruning, fertilization, and pest control.",
    activity1Sessions: "These efforts included awareness sessions with 120 farmers, which contributed to:",
    activity1Stat1: "100% increase in field productivity",
    activity1Stat2: "Raising average production from 300–400 flowers to 1,200–1,400 flowers per plant",
    activity1Fields: "12 demonstration fields",
    activity1Farmers: "120 farmers",
    
    activity2Title: "Introduction of Cooling Technology",
    activity2Desc: "Six refrigerated containers were delivered for transporting roses after harvest, with the aim of:",
    ...
    activity3Desc: "Production of compost from rose distillation waste was initiated and used as a natural, eco-friendly fertilizer, enhancing environmental sustainability and reducing fertilization costs.",
    
    activity4Title: "Rose Cultivation and Production Mapping",
    activity4Desc: "A technical study was conducted using remote sensing technologies to develop a precise cultivation map, resulting in:",
    ...
    activity4Standards: "In addition, specifications for Saudi rose oil were developed to ensure quality and competitiveness in the markets.",
    ...
    activity5Impact: "These efforts contributed to improving production efficiency and enhancing crop quality.",
    ...
    beekeepingBeneficiary2: "Productive families wishing to enter the beekeeping field",
    beekeepingBeneficiary3: "Youth entrepreneurs in rural areas",
    beekeepingBeneficiary4: "Local cooperatives specialized in honey production and marketing",
  ...
  ar: {
    ...
    rosesHeroTitle: "قطاع تنمية زراعة الورود وتجارة الورود",
    sector3Desc:
    ...
    coffeeHeroTitle: "قطاع تنمية وإنتاج وتصنيع وتسويق البن السعودي",
    coffeeIntroP1: "يُمثل قطاع البن والقهوة أحد الركائز الاستراتيجية لبرنمج 'ريف السعودية'، حيث يعتبر من المحاصيل النقدية ذات القيمة المضافة العالية ومكونًا رئيسيًا في دعم الأمن الغذائي وتعزيز الاقتصاد الريفي. يهدف البرنامج إلى إنشاء سلسلة قيمة متكاملة تبدأ من الزراعة وتنتهي بالتسويق، مع التركز على تحسين جودة البن السعودي وتمكين صغار المزارعين من الدخول إلى الأسواق المحلية والعالمية بثقة واستدامة.",
    coffeeIntroP2: "يُسهم البرنامج في زيادة الاكتفاء الذاتي من القهوة وتقليل الاعتماد على الاستيراد، من خلال دعم المزارعين بالتقنيات الحديثة وبناء البنية التحتية المتخصصة التي تشمل المشاتل والمصانع ومراكز الإرشاد الزراعي. بالإضافة إلى ذلك، يخلق البرنامج فرص عمل نوعية للشباب في مناطق الإنتاج ويحسّن دخل صغار المنتجين.",
    
    // Coffee Sector Objectives
    coffeeObj1: "تقديم وترويج البن كمحصول نقدي ضمن هيكل المحاصيل الزراعية في المملكة.",
    coffeeObj2: "زيادة مستوى الاكتفاء الذاتي وتقليل استيراد البن.",
    coffeeObj3: "زيادة دخل صغار المنتجين وتحسين حياةهم.",
    coffeeObj4: "إضافة قيمة اقتصادية من خلال معالجة وتسويق المنتجات.",
    coffeeObj5: "خلق فرص عمل للشباب في المناطق الريفية.",
    
    // Coffee Sector Key Areas of Action
    keyAreasActionTitle: "المناطق الرئيسية للعمل في قطاع البن",
    coffeeAction1: "تنفيذ الممارسات الزراعية الجيدة.",
    coffeeAction2: "تأسيس المشاتل والمزرعة النموذجية للبن السعودي.",
    coffeeAction3: "تقديم تقنيات حصاد حديثة وتقنيات ما بعد الحصاد لتقليل الخسائر.",
    coffeeAction4: "تسهيل الوصول إلى الائتمان الزراعي والتمويل.",
    coffeeAction5: "تأسيس مراكز الخدمة الاستشارية والمختبرات العلمية للبحث.",
    coffeeAction6: "تقديم الدعم المالي المباشر لصغار المنتجين.",
    coffeeAction7: "تشكيل اتحادات التعاونية ومراكز التسويق المتخصصة.",
    coffeeAction8: "بناء مرافق جمع المياه المطرية وضمان تغذية المياه للري.",
    coffeeAction9: "تدريب وتطوير المهارات الفنية والموارد البشرية.",
    coffeeAction10: "تطبيق أنظمة عزل النباتات لحماية الإنتاج المحلي.",
    
    // Coffee Stats Section
    coffeeStatsTitle: "الإحصائيات والمؤشرات",
    coffeeStatsSubtitle: "تظهر الإحصائيات للفترة 2020-2024 نموًا متسارعًا في إنتاج البن السعودي.",
    coffeeTotalSupport: "الدعم الإجمالي",
    coffeeProgressLabel: "إكمال البرنامج",
    coffeeBeneficiaries: "عدد المستفيدين",
    coffeeBeneficiariesLabel: "مستفيد",
    coffeeMen: "رجال",
    coffeeWomen: "نساء",
    coffeeGeographicalDistribution: "التوزيع الجغرافي للمستفيدين",
    coffeeProductionGrowth: "نمو الإنتاج",
    coffeeProductionSubtitle: "Annual production in tons",
    coffeeTons: "tons",
    coffeeGrowth: "Growth",
    coffeeTarget: "Target",
    ...
    fruitsObj3: "إضافة قيمة عالية وإيجاد فرص عمل من خلال الجمع والتصنيع والتسويق",
    ...
    fruitsWorkAxis1: "تطبيق الممارسات الزراعية الجيدة ويشمل ذلك العمليات الزراعية الحديثة",
    fruitsWorkAxis2: "إنشاء جمعيات تعاونية إنتاجية وتسويقية وتصنيعية",
    fruitsWorkAxis3: "إنشاء سدود صغيرة وحواجز اعتراضية لحصد مياه الأمطار وخزانات لتوفير مياه الري",
    fruitsWorkAxis4: "تطوير ونشر استخدام أنظمة الري الحديثة",
    fruitsWorkAxis5: "إنشاء مشاتل للفواكه شبه الاستوائية",
    fruitsWorkAxis6: "تطوير أنظمة تجفيف وتخزين الفواكه وإدخال تقنيات الحصاد الآلي وما بعد الحصاد للتقليل من الفاقد",
    fruitsWorkAxis7: "إنشاء مزارع نموذجية لنشر وتطوير زراعة الفواكه",
    fruitsWorkAxis8: "تدريب كوادر وزارة البيئة والمياه والزراعة في مجالات الفواكه شبه الاستوائية",
    fruitsWorkAxis9: "تسهيل الحصول على الائتمان المالي من خلال صندوق التنمية الزراعي",
    fruitsWorkAxis10: "تنمية مهارات وقدرات صغار المنتجين الزراعيين",
    fruitsWorkAxis11: "إنشاء مراكز لتقديم الخدمات الإرشادية والأبحاث والدراسات التطبيقية",
    ...
    fruitsTarget: "(مستهدف)",
    fruitsStatsNote: "*الأرقام للفترة 2020 - 2024 وتظهر نمواً متسارعاً في إنتاج الفاكهة ضمن مناطق الدعم.",
    ...
    fruitsProjectsIntro: "يعمل برنامج \"ريف السعودية\" على تنفيذ منظومة متكاملة من المشاريع في قطاع الفاكهة، بهدف تطوير الإنتاج، وتحسين الجودة، وتعزيز سلاسل القيمة من المزرعة إلى السوق، بما يسهم في رفع الاكتفاء الذاتي ودعم دخل المزارعين.",
    ...
    fruitsProject3: "تشغيل وصيانة الوحدة البحثية للزراعة بالمياه المتجددة في وادي بن هشبل",
    fruitsProject4: "توريد معدات ومواد زراعية لمشروع الوحدة البحثية بوادي بن هشبل",
    fruitsProject5: "تركيب مواد لمشاتل مركز أبحاث البستنة في نجران",
    fruitsProject6: "تجهيزات مختبرية لوحدة أبحاث مكافحة الأمراض النباتية والتربة في جازان",
    fruitsProject7: "تركيب أجهزة ومواد المختبر المركزي للثروة النباتية في الرياض",
    fruitsProject8: "تركيب أجهزة مركز مكافحة الأمراض النباتية والملوثات الكيميائية في الرياض",
    fruitsProject9: "تطبيق نظم الري المستدامة والتقنيات الزراعية الحديثة لصغار مزارعي محاصيل الفاكهة",
    fruitsFeasibilityTitle: "الجدوى الفنية والاقتصادية للمشاريع",
    fruitsFeasibilityIntro: "تسهم مشاريع قطاع الفاكهة في تحقيق مجموعة من المكاسب الاستراتيجية، من أبرزها:",
    fruitsFeasibility1: "رفع العمر الافتراضي للمنتجات من خلال عمليات التبريد والحفظ قبل التوزيع",
    fruitsFeasibility2: "تحسين عمليات النظافة والتعبئة وضمان مطابقة المنتجات للمعايير الصحية",
    fruitsFeasibility3: "دعم المزارعين بمشاريع نوعية لزيادة مساحة الحيازات الزراعية",
    ...
    fruitsFeasibility6: "تطوير وصيانة وتقليم الأشجار، ووقاية النخيل والأشجار المثمرة",
    fruitsFeasibility7: "تنظيف الحقول الزراعية من المخلفات وتحسين البيئة الإنتاجية",
    fruitsFeasibility8: "زيادة التوعية وبناء القدرات عبر تدريب المزارعين",
    fruitsFeasibility9: "نقل المعرفة وتطوير الممارسات الزراعية باستخدام التقنيات الحديثة",
    fruitsFeasibility10: "إيجاد حلول تسويقية مستدامة وإتاحة منافذ بيع مباشرة",
    fruitsFeasibility11: "تقليل سلاسل الإمداد بين المنتج والمستهلك لرفع كفاءة التسويق",
    fruitsProjectObjectivesTitle: "أهداف المشاريع",
    fruitsProjectObjective1: "إنشاء مراكز خدمات زراعية وتسويقية متكاملة للفواكه تشمل الفرز والتنظيف والتعبئة والتغليف والنقل",
    fruitsProjectObjective2: "تدريب المزارعين والمختصين وأصحاب المصلحة في الحقول الإرشادية على الممارسات الزراعية الحديثة",
    fruitsProjectObjective3: "تشغيل وصيانة الوحدات البحثية وتوفير المعدات والأجهزة اللازمة",
    fruitsKeyWorks2024Title: "أهم الأعمال المنفذة في 2024",
    fruitsWork1Title: "إنشاء مشاتل جديدة",
    fruitsWork1Desc: "تم اختيار موقعين لإنشاء مشاتل فاكهة تعاونية لدى الجمعية الزراعية بالطائف وجمعية التسويق الزراعي بجازان، بسعة تقديرية 15 ألف شتلة لكل مشتل، علماً بأن العمل جارٍ لإعداد الملفات وإنشاء المشتلين لخدمة المزارعين.",
    ...
    fruitsWork3Desc: "تم توصيف 6 أصناف مستوردة من العنب والتين والمشمش واللوز في الحقل الإرشادي بالبلجرشي بالتعاون مع مرك�� البذور والتقاوي بالباحة، بهدف تحديد المواصفات المورفولوجية والإنتاجية وقياس توافق الأصناف مع مناخ المنطقة وإكثار الأصناف المناسبة ذات الإنتاجية العالية.",
    fruitsWork4Title: "تطوير ريادة الأعمال الزراعية للسيدات",
    fruitsWork4Duration: "تنفيذ برنامج تدريبي استمر 3 أشهر شمل:",
    fruitsWork4Point1: "اختيار وتدريب 15 رائدة أعمال زراعية على إنشاء وتشغيل مشاتل زراعية خاصة بمدينة بلجرشي بمنطقة الباحة",
    ...
    fruitsWork4Point5: "تطوير مهارات التصنيع التحويلي خصوصاً الرمان وصناعة منتجات:",
    ...
    fruitsWork5Point2: "إعداد برامج الإدارة المتكاملة لمكافحة البياض الدقيقي وذبابة الفاكهة والنيماتودا وفراشة الرمان",
    fruitsWork5Point3: "سيتم رفع البرامج واعتمادها بالتعاون مع مركز وقاء للاتفاق على آلية التنفيذ والبدء في التطبيق.",
    ...
    livestockIntro2: "يسعى البرنامج إلى إحداث نقلة نوعية في نظم الإنتاج الحيواني التقليدي عبر إدخال التقنيات الحديثة، وتطوير البنية التحتية، وتمكين المربين من الاستفادة من الخدمات البيطرية والإرشادية والتمويلية، بما يسهم في رفع الإنتاجية وتحسين جودة المنتجات الحيوانية وخلق فرص اقتصادية مستدامة في القطاع الريفي.",
    livestockMainGoalsTitle: "الأهداف الرئيسية للقطاع:",
    livestockGoal1: "تنمية الأغنام والماعز والإبل في المناطق الصحراوية لتنظيم الاستخدام الأمثل للموارد الطبيعية في هذه المنطقة الهامشية.",
    livestockGoal2: "تحسين الإنتاجية وزيادة دخل الأسر من صغار المربين وتحسين سبل معيشتهم.",
    livestockGoal3: "تطوير نظم الإنتاج الحيواني التقليدي بشكل يحافظ على دورها في تعزيز الأمن الغذائي.",
    livestockGoal4: "تنمية إنتاج لبن الماعز والإبل وتصنيعه كمصدر غذائي خاص للأطفال والنساء في منتجات توافق احتياجات السوق.",
    livestockWorkAxesTitle: "محاور العمل في قطاع الماشية:",
    livestockAxis1: "إنشاء بنك الأصول الوراثية لتطوير السلالات المحلية لصغار مربي الماشية.",
    livestockAxis2: "تطوير البحث التطبيقي والتحسين الوراثي للسلالات المحلية والهجين لزيادة إنتاجها من الحملان والألبان.",
    livestockAxis3: "تقديم الدعم لإنشاء أو تقوية جمعيات تعاونية زراعية",
    livestockAxis4: "تبني ونشر التقنيات الحديثة في نظم التربية والإنتاج والرعاية المناسبة والتغذية المتوازنة، وعلى كيفية تسويق منتجاتهم لتحسين دخلهم.",
    livestockAxis5: "وضع سياسة تمويلية لتطوير ودعم صغار المربين لتعديل نمط التربية والإنتاج بالقطاع الريفي.",
    livestockAxis6: "تحسين الإرشاد البيطري وتطوير نظم وخدمات الرعاية والبيطرة وتغذية قطعان الأغنام والماعز والإبل في المناطق الصحراوية.",
    livestockAxis7: "إنشاء نظام متطور لتداول وتسويق منتجات القطاع الحيواني الريفي.",
    livestockAxis8: "إدارة رعي قطعان الثروة الحيوانية لتتسع الطاقة الاستيعابية للمراعي.",
    livestockAxis9: "زراعة أنواع وسلالات الأعلاف التي تتحمل الجفاف كعلف للماشية، وإعادة تأهيل المراعي بحماية مستودعات الأعلاف في المواسم الجافة.",
    livestockAxis10: "تطبيق أنظمة الحجر البيطري.",
    livestockAxis11: "إعداد قاعدة بيانات للقطاع تتضمن حصر أعدادها وتسجيل كافة بياناتها وترقيمها حتى يتسنى متابعتها ودراستها وتقييمها.",
    livestockObj1: "زيادة إنتاجية الثروة الحيوانية وتحسين جودة السلالات من خلال برامج تربية حديثة",
    livestockObj2: "تعزيز جودة منتجات الألبان وضمان الامتثال لمعايير الصحة والسلامة",
    livestockObj3: "توفير رعاية بيطرية شاملة وخدمات صحية وقائية للثروة الحيوانية",
    livestockObj4: "تطوير قنوات التسويق وخلق فرص دخل مستقرة لصغار المربين",
    livestockAction1Title: "برامج تحسين السلالات",
    livestockAction1Desc: "تنفيذ برامج تربية انتقائية وإدخال سلالات محسنة لتعزيز الإنتاجية ومقاومة الأمراض",
    livestockAction2Title: "خدمات الرعاية البيطرية",
    livestockAction2Desc: "توفير رعاية بيطرية شاملة تشمل التطعيمات والعلاج والمراقبة الصحية المنتظمة",
    livestockAction3Title: "تحسين جودة الأعلاف",
    livestockAction3Desc: "تطوير جودة الأعلاف الحيوانية وضمان التوازن الغذائي لزيادة الإنتاج إلى أقصى حد",
    livestockAction4Title: "دعم إنتاج الألبان",
    livestockAction4Desc: "دعم مربي الألبان بمعدات حديثة وتدريب وأنظمة مراقبة الجودة",
    livestockAction5Title: "التسويق والتوزيع",
    livestockAction5Desc: "إنشاء قنوات تسويقية وربط المربين بالأسواق المحلية والإقليمية",
    livestockAction6Title: "التدريب وبناء القدرات",
    livestockAction6Desc: "توفير التدريب الفني على ممارسات إدارة الثروة الحيوانية الحديثة والمهارات التجارية",
    livestockProject1Title: "برنامج دعم صغار مربي الماشية",
    livestockProject1Desc: "برنامج دعم شامل يوفر التمويل والتدريب والمساعدة الفنية لمربي الماشية صغار الحجم",
    livestockProject2Title: "مبادرة تحسين جودة الألبان",
    livestockProject2Desc: "مبادرة تركز على تعزيز جودة إنتاج الألبان من خلال المعدات الحديثة وأنظمة مراقبة الجودة",
    livestockProject3Title: "العيادات البيطرية المتنقلة",
    livestockProject3Desc: "خدمات بيطرية متنقلة تصل إلى المناطق الريفية النائية لتوفير الرعاية الصحية للثروة الحيوانية",
    livestockProject4Title: "مراكز إنتاج الأعلاف",
    livestockProject4Desc: "إنشاء مراكز محلية لإنتاج الأعلاف لضمان التغذية الجيدة بأسعار معقولة",
    livestockFigure1: "12,500",
    ...
    newsDesc:
      'تابع أحدث الأخبار والمبادرات والفعاليات لبرنامج "ريف السعودية"',
    viewAll: "عرض الكل",
    ...
    news3Title:
      '"ريف السعودية" يطلق مسرّعة "ريف" لريادة الأعمال الريفية',
    ...
    vision2030Point1Text: "المساهمة في تنويع الاقتصاد الوطني من خلال تطوير القطاعات الزراعية ودعم ريادة الأعمال الريفية.",
    vision2030Point2Title: "الأمن الغذائي",
    vision2030Point2Text: "تعزيز الأمن الغذائي للمملكة من خلال ممارسات زراعية مستدامة وزيادة الإنتاج المحلي.",
    vision2030Point3Title: "التنمية الريفية",
    vision2030Point3Text: "تحسين جودة الحياة في المناطق الريفية من خلال البنية التحتية والخدمات والفرص الاقتصادية.",
    vision2030Point4Title: "خلق فرص العمل",
    vision2030Point4Text: "خلق فرص عمل مستدامة للمواطنين السعوديين في القطاعات الزراعية والقطاعات ذات الصلة.",
    vision2030Point5Title: "الابتكار والتكنولوجيا",
    vision2030Point5Text: "اعتماد التقنيات الزراعية الحديثة وأساليب الزراعة المبتكرة لتعزيز الإنتاجية.",
    vision2030Point6Title: "الاستدامة البيئية",
    vision2030Point6Text: "تعزيز ممارسات الزراعة المستدامة التي تحافظ على الموارد الطبيعية وتحمي البيئة.",
    vision2030Point7Title: "الحفاظ على التراث",
    vision2030Point7Text: "الحفاظ على التراث الزراعي التقليدي مع تحديث أساليب وتقنيات الإنتاج.",
    vision2030Point8Title: "التنافسية العالمية",
    vision2030Point8Text: "وضع المنتجات الزراعية السعودية بشكل تنافسي في الأسواق الإقليمية والدولية.",
    vision2030CTA1: "استكشف الأهداف الاستراتيجية",
    vision2030CTA2: "اكتشف قطاعاتنا",
    
    // Vision & Mission Section
    visionMissionVisionTitle: "رؤيتنا",
    visionMissionVisionText: "أن نكون القوة الرائدة في التنمية الريفية الزراعية المستدامة في المملكة العربية السعودية بحلول عام 2030، وإنشاء مجتمعات ريفية مزدهرة بمستويات معيشة محسّنة ورخاء اقتصادي.",
    visionMissionMissionTitle: "رسالتنا",
    visionMissionMissionText: "تمكين صغار المزارعين والأسر المنتجة من خلال برامج الدعم المتكاملة والتقنيات الزراعية الحديثة والممارسات المستدامة التي تضمن الأمن الغذائي والنمو الاقتصادي.",
    
    // Strategic Objectives
    strategicObj1Title: "التمكين الاقتصادي",
    strategicObj1Text: "دعم صغار المزارعين والأسر الريفية لإنشاء مصادر دخل مستدامة من خلال المساعدة المالية الموجهة والتدريب والوصول إلى الأسواق.",
    strategicObj2Title: "الإنتاجية الزراعية",
    strategicObj2Text: "تعزيز الإنتاج والكفاءة الزراعية من خلال تقنيات الزراعة الحديثة واعتماد التكنولوجيا وتطوير البنية التحتية.",
    strategicObj3Title: "التطوير التقني",
    strategicObj3Text: "بناء القدرة التقنية من خلال برامج تدريبية شاملة وورش عمل ومبادرات نقل المعرفة عبر جميع القطاعات الزراعية.",
    strategicObj4Title: "الابتكار والتكنولوجيا",
    strategicObj4Text: "دمج التقنيات الزراعية المتقدمة والحلول الرقمية لتحسين جودة الإنتاج والكفاءة التشغيلية.",
    strategicObj5Title: "الاستدامة البيئية",
    strategicObj5Text: "تعزيز ممارسات الزراعة المستدامة التي تحافظ على الموارد الطبيعية وتحمي التنوع البيولوجي وتضمن الصحة البيئية طويلة الأجل.",
    strategicObj6Title: "الوصول إلى الأسواق والتصدير",
    strategicObj6Text: "تسهيل الوصول إلى الأسواق للمنتجات المحلية وتعزيز قدرات التصدير للوصول إلى الأسواق الإقليمية والدولية.",
    strategicObj7Title: "الأمن الغذائي",
    strategicObj7Text: "المساهمة في الأمن الغذائي للمملكة من خلال زيادة الإنتاج المحلي للمحاصيل الاستراتيجية وتقليل الاعتماد على الواردات.",
    strategicObj8Title: "جودة الحياة",
    strategicObj8Text: "تحسين مستويات المعيشة في المجتمعات الريفية من خلال تطوير البنية التحتية والخدمات الأساسية والفرص الاقتصادية.",
    
    // Organizational Structure
    orgStructureTitle: "الهيكل التنظيمي",
    orgStructureParagraph1: "يعمل برنامج ريف السعودية تحت إشراف وزارة البيئة والمياه والزراعة بهيكل تنظيمي واضح مصمم لضمان التنفيذ الفعال والمساءلة. يتضمن الهيكل لجان إشراف استراتيجية وفرق إدارة تشغيلية ووحدات تقنية متخصصة تعمل بالتنسيق لتحقيق أهداف البرنامج.",
    orgStructureParagraph2: "يمكّن هذا الإطار التنظيمي من اتخاذ القرارات بكفاءة وتخصيص الموارد وتقديم البرامج في جميع مناطق المملكة. يسهّل التعاون بين مختلف الجهات الحكومية وشركاء التنمية وأصحاب المصلحة لتعظيم تأثير البرنامج وضمان التنمية الريفية المستدامة.",
    ...
    partnersIntro: "يعمل ريف السعودية في شراكة وثيقة مع الجهات الحكومية ومنظمات التنمية والمؤسسات البحثية وشركات القطاع الخاص لتقديم الدعم الشامل وتحقيق التنمية الريفية المستدامة في جميع أنحاء المملكة.",
    ...
    achievementsTotalBeneficiaries: "إجمالي عدد المستفيدين منذ انطلاق البرنامج في 2020",
    ...
    achievementsFinancialSupport: "إجمالي قيمة الدعم المالي منذ انطلاق البرنامج",
    ...
    achievementsRuralProducts: "عدد المنتجات (منتجات الميزة النسبية) المدعومة من برنامج ريف السعو��ية",
    ...
    achievementsHighlight1: "تمكين أكثر من 87,000 مستفيد في جميع مناطق المملكة من خلال برامج الدعم الشاملة للتنمية الزراعية والريفية",
    achievementsHighlight2: "تنفيذ 129 دورة تدريبية متخصصة تغطي التقنيات الزراعية الحديثة وإدارة الأعمال والممارسات الزراعية المستدامة",
    achievementsHighlight3: "إنشاء 64 علامة تجارية للمنتجات الريفية تربط المنتجين المحليين بالأسواق الوطنية والدولية مع شهادات الجودة",
    achievementsHighlight4: "تنفيذ تقنيات الزراعة الذكية المبتكرة في أكثر من 105 مشروع، بدمج أجهزة استشعار إنترنت الأشياء والزراعة الدقيقة وتحليل البيانات",
    achievementsHighlight5: "دعم رائدات الأعمال من خلال برامج متخصصة في إنتاج العسل والحرف اليدوية والمنتجات الزراعية ذات القيمة المضافة",
    achievementsHighlight6: "تحقيق تأثير بيئي كبير من خلال مبادرات الزراعة المستدامة وتوزيع أكثر من 15.5 مليون شتلة",
    achievementsHighlight7: "تنظيم منتديات ومعارض زراعية وطنية تجتذب آلاف المشاركين وتعرض قصص نجاح التنمية الريفية",
    achievementsAwardsTitle: "التقدير والجوائز الدولية",
    achievementsAward1Title: "جائزة الأمم المتحدة للخدمة العامة",
    achievementsAward1Desc: "تقديراً للتميز في تقديم الخدمات العامة وبرامج التنمية الريفية المبتكرة",
    achievementsAward2Title: "جائزة الأميرة الملكية للتدريب",
    achievementsAward2Desc: "تكريماً للإنجازات المتميزة في التدريب وتنمية رأس المال البشري",
    achievementsAward3Title: "جائزة الابتكار العربي",
    achievementsAward3Desc: "منحت لتنفيذ التقنيات الزراعية المتطورة وحلول الزراعة الذكية",
    achievementsAward4Title: "التميز في التحول الرقمي",
    achievementsAward4Desc: "تقديراً للحلول الرقمية الرائدة في التنمية الزراعية وخدمات المستفيدين",
    achievementsAward5Title: "جائزة حائل للتنمية الإقليمية",
    achievementsAward5Desc: "احتفاءً بالتأثير التحولي على المجتمعات الريفية في منطقة حائل",
    achievementsCertificationsTitle: "شهادات الجودة والمعايير",
    achievementsISOTitle: "معتمد ISO 9001:2015",
    achievementsISODesc: "عمليات برنامجنا معتمدة وفقاً لمعايير إدارة الجودة الدولية، مما يضمن التميز في تقديم الخدمات والتحسين المستمر ورضا أصحاب المصلحة في جميع مبادراتنا.",
    achievementsGuinnessTitle: "رقم قياسي في موسوعة غينيس",
    achievementsGuinnessDesc: "تحقيق رقم قياسي في موسوعة غينيس لأكبر حملة لتوزيع الشتلات، بزراعة أكثر من 15.5 مليون شجرة في المناطق الريفية خلال سنة واحدة من المبادرة.",
    achievementsGuinness1: "تحقيق رقم قياسي في موسوعة غينيس لأكبر حملة لتوزيع الشتلات، بزراعة أكثر من 15.5 مليون شجرة في المناطق الريفية خلال سنة واحدة من المبادرة.",
    achievementsISO1Title: "ISO 9001:2015 إدارة الجودة",
    achievementsISO1Desc: "معتمد للتميز في أنظمة إدارة الجودة، مما يضمن تقديم خدمات متسقة والتحسين المستمر.",
    achievementsISO2Title: "ISO 22301 استمرارية الأعمال",
    achievementsISO2Desc: "معتمد لإدارة استمرارية الأعمال، مما يضمن المرونة والعمليات المستدامة أثناء الاضطرابات.",
    achievementsISO3Title: "ISO 56002 إدارة الابتكار",
    achievementsISO3Desc: "معتمد لأنظمة إدارة الابتكار، تعزيز الإبداع ودفع الابتكار المستمر في التنمية الزراعية.",
    achievementsISOSubtitle: "ملتزمون بالمعايير الدولية للتميز والجودة",
    achievementsAwardsSubtitle: "معترف به عالمياً للتميز في التنمية الريفية المستدامة",
    achievementsIndicatorsSubtitle: "قياس التحول الاقتصادي الإيجابي في المجتمعات الريفية",
    achievementsAward6Title: "جائزة حائل للتنمية الإقليمية",
    achievementsAward6Desc: "احتفاءً بالتأثير التحولي على المجتمعات الريفية في منطقة حائل",
    achievementsCTA1: "عرض التقرير الكامل",
    achievementsCTA2: "تحميل الإحصائيات",
    
    // Beekeeping Sector
    beekeepingDevelopmentHoneyProduction: "تطوير تربية النحل وإنتاج العسل",
    beekeepingIntro1: "تمثل مبادرة تطوير تربية النحل وإنتاج العسل أحد أهم الركائز الحيوية لبرنامج ريف السعودية، حيث تهدف إلى تطوير وتعزيز قطاع النحالة في المملكة من خلال برامج دعم شاملة ومبتكرة.",
    beekeepingIntro2: "تركز هذه المبادرة على تحسين جودة إنتاج العسل، ودعم النحالين المحليين، وتطوير ممارسات تربية النحل باستخدام أساليب علمية حديثة تتماشى مع المعايير الدولية مع الحفاظ على التراث السعودي التقليدي في تربية النحل.",
    beekeepingIntro3: "من خلال الشراكات الاستراتيجية وبرامج الدعم المتكاملة، نعمل على تحويل تربية النحل من ممارسات فردية تقليدية إلى قطاع اقتصادي مستدام يساهم في الأمن الغذائي والتنمية الاقتصادية الريفية.",
    honeyWork1: "دعم النحالين بخلايا نحل حديثة ومعدات تربية نحل مستدامة",
    honeyWork2: "تطوير تقنيات تربية النحل من خلال برامج التدريب والدعم الفني",
    honeyWork3: "تعزيز الابتكار في إنتاج العسل وتطوير منتجات النحل",
    honeyWork4: "إنشاء أنظمة لوجستية لجمع وتوزيع منتجات العسل",
    honeyWork5: "بناء شراكات مع مراكز البحوث والمؤسسات الأكاديمية",
    honeyWork6: "توفير الدعم المالي والقروض الميسرة لمشاريع تربية النحل",
    honeyWork7: "إنشاء جمعيات تعاونية للنحالين والمنتجين",
    honeyWork8: "زراعة نباتات صديقة للنحل وإنشاء مراعي نحل طبيعية",
    honeyWork9: "الحفاظ على سلالات النحل المحلية والحفاظ على التنوع البيولوجي",
    honeyWork10: "تنظيم دورات تدريبية في تربية النحل الحديثة ومعايير جودة العسل",
    keyWorkAreasHoneySector: "المجالات الرئيسية للعمل في قطاع العسل",
    ...
    benefit6Desc:
      "دعم البحث الزراعي واعتماد التقنيات المبتكرة.",
    ...
    milestone3Desc:
      "إطلاق مراكز الابتكار الزراعي ومسرّعات ريادة الأعمال",
    milestone4Year: "2025",
    ...
    reportCorruption: "รายงาน الفساد",
    ...
    // Roses & Aromatic Plants Sector
    rosesIntro1:
      "يُمثل قطاع الورد والنباتات العطرية أحد القطاعات المتخصصة الواعدة التي يدعمها برنامج ريف السعودية، نظراً لقيمته الاقتصادية والثقافية والبيئية العالية وارتباطه التاريخي بعدة مناطق من المملكة، أبرزها الطائف وجازان وعسير ومكة المكرمة والباحة والمدينة المنوّرة.",
    rosesIntro2:
      "يهدف البرنامج إلى تطوير سلسلة القيمة الكاملة للورد والنباتات العطرية، بدءاً من زراعة الشتلات وتحسين الأصناف، مروراً بعمليات الحصاد والتجفيف والتقطير والتصنيع، ووصولاً إلى التسويق المحلي والعالمي لدهن الورد وماء الورد والمنتجات العطرية ذات الصلة.",
    rosesIntro3:
      "كما يساهم البرنامج في دعم صغار المزارعين وتمكينهم من اعتماد التقنيات الحديثة، وتحقيق دخل مستدام، والحفاظ على هذا الإرث الزراعي الذي توارثته الأجيال عبر مئات السنين كجزء من هوية المملكة الثقافية والاقتصادية.",

    rosesObj1:
      "تحقيق الريادة في إنتاج وتصنيع وتسويق الورد.",
    rosesObj2:
      "زيادة دخل صغار المنتجين من خلال إضافة القيمة عبر التصنيع والتسويق.",
    rosesObj3:
      "تصدير منتجات الورد إلى دول الخليج وأوروبا.",
    rosesObj4:
      "خلق فرص عمل عديدة، وخاصة للمرأة.",

    keyAreasOfAction: "مجالات العمل الرئيسية",
    rosesAction1:
      "تطوير التقنيات المناسبة لزراعة وإنتاج الورد، بما في ذلك عمليات الفرز والتخزين والإعداد.",
    rosesAction2:
      "توفير الدعم المالي والبنية التحتية المؤسسية لمنتجي الورد.",
    rosesAction3:
      "إنشاء معامل التقطير.",
    rosesAction4:
      "إدخال الحصاد الآلي وتقنيات ما بعد الحصاد للحد من الخسائر.",
    rosesAction5:
      "إنشاء وتعزيز قدرات التعاونيات الزراعية المتخصصة لدعم صغار المنتجين.",
    rosesAction6:
      "دعم وتطوير أساليب التسويق الإلكتروني للورد ومنتجاته.",
    rosesAction7:
      "زراعة الأشجار الحراجية مثل الأسيجة ومصدات الرياح والسياج الحي.",
    rosesAction8:
      "إنشاء السدود الصغيرة وحواجز الاعتراض لحصاد مياه الأمطار.",
    rosesAction9:
      "تطوير وتوسيع استخدام أنظمة الري الحديثة للري التكميلي.",
    rosesAction10:
      "إنشاء حقول إيضاحية للبحث والدعم الفني لمنتجي الورد وتدريب الكوادر الفنية.",
    rosesAction11:
      "إنشاء وتطوير مشاتل متخصصة لإنتاج أصناف الورد المهمة وتوزيع هذه الشتلات على المنتجين.",

    // Figures and Indicators
    figuresIndicators: "الأرقام والمؤشرات",
    totalSupport: "إجمالي الدعم",
    millionSAR: "مليون ريال سعودي",
    ...
    productionGrowthDesc: "تشير الأرقام للفترة 2020-2024 إلى نمو متسارع في إنتاج الورد والنباتات العطرية.",
    ...
    projectsIntro: "يقوم برنامج ريف السعودية بتنفيذ حزمة من المشاريع المتخصصة في قطاع الورد والنباتات العطرية، بهدف زيادة الإنتاج المحلي وتعزيز سلاسل القيمة وتطوير الصناعات المرتبطة بالعطور ومستخلصات النباتات في مختلف مناطق المملكة.",
    keySectorProjects: "المشاريع الرئيسية للقطاع",
    project1: "إنشاء مدن متخصصة للورد والنباتات العطرية في منطقة جازان.",
    project2: "إنشاء مشاتل متخصصة للورد والنباتات العطرية في منطقة جازان.",
    project3: "إنشاء مصنع لاستخلاص الزيوت العطرية من الورد والنباتات العطرية مع المشاتل في محافظة أبو عريش (الحديقة الوطنية).",
    project4: "تقديم الدعم الاستشاري لتنفيذ المدارس الحقلية باستخدام تطبيقات الذكاء الاصطناعي.",
    project5: "تطوير قاعدة بيانات لمزارعي الورد والياسمين والكافور والعسل لرصد احتياجات القوى العاملة.",
    project6: "توريد معدات وأدوات مختبرية لتحليل المياه والتربة في عدة مناطق بالمملكة.",
    project7: "إنشاء مركز الورد في مدينة الطائف.",
    project8: "إنشاء وتجهيز مختبر زراعة الأنسجة لإنتاج ورود عالية الجودة في منطقة الرياض.",
    project9: "توريد الصوبات الزراعية وهياكل الظل الزراعي وإنشاء شبكات ري لمدن الورد والنباتات العطرية في جازان.",
    project10: "إعادة تأهيل مختبر زراعة الأنسجة لإنتاج ورود عالية الجودة في الرياض.",
    project11: "تطبيق أنظمة الري المستدام والتقنيات الزراعية الحديثة لصغار مزارعي الورد في محافظة الطائف.",
    project12: "توريد عيادات متنقلة لتشخيص أمراض وآفات الورد والنباتات الطبية والعطرية.",
    project13: "توريد معدات لوحدات الإرشاد الفني للتصوير وتحرير الفيديو لفروع الوزارة في المناطق المختلفة.",
    technicalEconomicFeasibility: "الجدوى الفنية والاقتصادية للمشاريع",
    feasibilityIntro: "تساهم مشاريع قطاع الورد والنباتات العطرية في تحقيق عدة مكاسب استراتيجية، من بينها:",
    feasibility1: "زيادة الإنتاج المحلي من الورد وتقليل الاعتماد على الواردات.",
    feasibility2: "تعزيز الإيرادات المحلية وخلق فرص عمل جديدة للمزارعين.",
    feasibility3: "تعزيز التراث الزراعي المرتبط بزراعة الورد كجزء من الهوية الثقافية الإقليمية.",
    feasibility4: "دعم الممارسات الزراعية المستدامة في إدارة موارد المياه والتربة.",
    ...
    feasibility7: "تشجيع صغار المزارعين على اعتماد أفضل الممارسات الزراعية.",
    feasibility8: "تنويع المحاصيل العطرية لتحقيق دخل مستدام.",
    feasibility9: "خفض التكاليف اللوجستية من خلال توطين الصناعات عبر منشآت التقطير والتصنيع.",
    feasibility10: "خلق بيئات نباتية متنوعة تدعم الاستدامة البيئية.",
    projectObjectives: "أهداف المشاريع",
    projectObjectivesIntro: "تركز مشاريع قطاع الورد والنباتات العطرية ضمن برنامج \"ريف السعودية\" على تحقيق الأهداف التالية:",
    objective1: "زيادة إنتاج المملكة من الورد لتلبية الطلب في السوق المحلي والحد من الاعتماد على الواردات.",
    ...
    activity1Title: "إنشاء الحقول التجريبية",
    activity1Desc: "تم تنفيذ إجمالي 12 حقلاً تجريبياً لتطوير زراعة الورد والياسمين في منطقتي الطائف وجازان، مع تطبيق أحدث الممارسات في التقليم والتسميد ومكافحة الآفات.",
    activity1Sessions: "تضمنت هذه الجهود جلسات توعية مع 120 مزارعاً، مما ساهم في:",
    activity1Stat1: "زيادة إنتاجية الحقول بنسبة 100%",
    activity1Stat2: "رفع متوسط الإنتاج من 300-400 زهرة إلى 1,200-1,400 زهرة لكل نبتة",
    activity1Fields: "12 حقل تجريبي",
    activity1Farmers: "120 مزارعاً",
    
    activity2Title: "إدخال تقنية التبريد",
    activity2Desc: "تم توريد ستة حاويات مبردة لنقل الورد بعد الحصاد، بهدف:",
    activity2Point1: "الحفاظ على جودة الورد قبل التقطير",
    activity2Point2: "إطالة عمر تخزين الزهور",
    activity2Point3: "تقليل الفاقد وتحسين كفاءة سلسلة الإمداد",
    activity2Containers: "6 حاويات مبردة",
    
    activity3Title: "إدخال تقنية التسميد العضوي",
    activity3Desc: "تم البدء في إنتاج السماد العضوي من مخلفات تقطير الورد واستخدامه كسماد طبيعي صديق للبيئة، مما يعزز الاستدامة البيئية ويقلل تكاليف التسميد.",
    
    activity4Title: "رسم خريطة زراعة وإنتاج الورد",
    activity4Desc: "أُجريت دراسة فنية باستخدام تقنيات الاستشعار عن بعد لتطوير خريطة زراعة دقيقة، مما أسفر عن:",
    activity4Suitable: "مساحة الزراعة المناسبة: 621 هكتاراً",
    activity4Current: "المساحة المزروعة حالياً: 346 هكتاراً",
    activity4Expansion: "إمكانية التوسع المستقبلي: 275 هكتاراً",
    activity4Standards: "بالإضافة إلى ذلك، تم تطوير مواصفات زيت الورد السعودي لضمان الجودة والتنافسية في الأسواق.",
    
    activity5Title: "ورش العمل والزيارات الميدانية",
    activity5Desc: "تضمنت أنشطة التدريب والمتابعة:",
    activity5Visits: "35 زيارة ميدانية لمراقبة أنظمة الري",
    activity5Training: "تدريب 149 مزارعاً على تقنيات الزراعة الحديثة",
    activity5Jasmine: "زيارات لمزارع الياسمين في الطائف",
    activity5Monitoring: "متابعة برامج مكافحة الآفات والأمراض",
    activity5Impact: "ساهمت هذه الجهود في تحسين كفاءة الإنتاج وتعزيز جودة المحاصيل.",
    activity5FieldVisits: "35 زيارة ميدانية",
    activity5TrainedFarmers: "149 مزارعاً تم تدريبهم",
    ...
    beekeepingObj1:
      "تحسين جودة العسل السعودي والالتزام بمعايير الجودة العالمية لتعزيز التنافسية في الأسواق المحلية والعالمية.",
    beekeepingObj2:
      "توفير برامج تدريبية وتعليمية لمربي النحل لرفع إنتاجيتهم وتحسين مهاراتهم التسويقية والإدارية.",
    beekeepingObj3:
      "تطوير البنية التحتية الخاصة بتربية النحل، مثل المناحل الحديثة ومختبرات العسل ومرافق فحص الجودة.",
    beekeepingObj4:
      "دعم البحث والابتكار في مجال تربية النحل لتطوير سلالات نحل مقاومة للآفات وتحسين إنتاجية الخلايا.",
    ...
    beekeepingBeneficiary4: "التعاونيات المحلية المتخصصة في إنتاج العسل وتسويقه",

    futurePlans: "الخطط المستقبلية",
    beekeepingFuture1:
      "إنشاء مراكز متخصصة لتربية النحل في المناطق الرئيسية للإنتاج في المملكة.",
    beekeepingFuture2:
      "إطلاق برنامج شهادة العسل السعودي لضمان الجودة والنقاء.",
    beekeepingFuture3:
      "تعزيز الشراكات مع المراكز البحثية والجامعات لتطوير القطاع.",
    beekeepingFuture4:
      "توسيع فرص التصدير للعسل السعودي إلى الأسواق العالمية.",
  },
};
