...
export function CoffeeKeyAreas() {
  ...
  const areas = [
    ...
    },
    {
      ...
      key: "coffeeAction2",
      color: "#F1BC28",
      gradient: "from-[#F1BC28] to-[#d4a324]",
    },
    {
      icon: TrendingUp,
      key: "coffeeAction3",
      color: "#035938",
      gradient: "from-[#035938] to-[#024028]",
    },
    {
      icon: DollarSign,
      key: "coffeeAction4",
      color: "#52BC88",
      gradient: "from-[#52BC88] to-[#3a9d6f]",
    },
    {
      icon: HeartHandshake,
      key: "coffeeAction5",
        ...
        >
          <defs>
            ...
            >
              <stop
                offset="0%"
                style={{ stopColor: "#52BC88", stopOpacity: 0.3 }}
              />
              <stop
                offset="50%"
                style={{ stopColor: "#F1BC28", stopOpacity: 0.3 }}
              />
              <stop
                offset="100%"
                style={{ stopColor: "#035938", stopOpacity: 0.3 }}
              />
            </linearGradient>
          </defs>
          <path
