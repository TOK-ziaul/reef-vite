...
export function RosesProjects() {
  ...
  const keyProjects = [
    { 
      ...
      key: 'project1', 
      color: '#035938',
      image: 'https://images.unsplash.com/photo-1708796705570-33fd29ef67d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwbGFudCUyMG51cnNlcnklMjBzZWVkbGluZ3N8ZW58MXx8fHwxNzY5OTUyNjEyfDA&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Sprout, 
      key: 'project2', 
      color: '#52BC88',
      image: 'https://images.unsplash.com/photo-1707086547436-a256cdc6c4da?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwbGFudCUyMHNlZWRsaW5nJTIwZ3Jvd3RofGVufDF8fHx8MTc2OTk0OTY1OXww&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Factory, 
      key: 'project3', 
      color: '#F1BC28',
      image: 'https://images.unsplash.com/photo-1619070284836-e850273d69ac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBmYWN0b3J5JTIwaW5kdXN0cmlhbHxlbnwxfHx8fDE3Njk5NTI2MDh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Brain, 
      key: 'project4', 
      color: '#035938',
      image: 'https://images.unsplash.com/photo-1759884247146-b6cba3d92341?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXNlYXJjaCUyMGRldmVsb3BtZW50JTIwaW5ub3ZhdGlvbnxlbnwxfHx8fDE3Njk5NTMyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Database, 
      key: 'project5', 
      color: '#52BC88',
      image: 'https://images.unsplash.com/photo-1597852074816-d933c7d2b988?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkYXRhYmFzZSUyMHRlY2hub2xvZ3klMjBkaWdpdGFsfGVufDF8fHx8MTc2OTk1MjYwOHww&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: TestTube, 
      key: 'project6', 
      color: '#F1BC28',
      image: 'https://images.unsplash.com/photo-1768498950637-88d073faa491?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYWJvcmF0b3J5JTIwdGVzdGluZyUyMGVxdWlwbWVudHxlbnwxfHx8fDE3Njk5NTMyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Gem, 
      key: 'project7', 
      color: '#035938',
      image: 'https://images.unsplash.com/photo-1766430191918-2cca9f763790?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnZW1zdG9uZSUyMG5hdHVyYWwlMjByZXNvdXJjZXN8ZW58MXx8fHwxNzY5OTUzMjE0fDA&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Microscope, 
      key: 'project8', 
      color: '#52BC88',
      image: 'https://images.unsplash.com/photo-1742206594477-15139139c0df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYWJvcmF0b3J5JTIwc2NpZW50aXN0JTIwbWljcm9zY29wZXxlbnwxfHx8fDE3Njk5NTI2MDd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Warehouse, 
      key: 'project9', 
      color: '#F1BC28',
      image: 'https://images.unsplash.com/photo-1680724525083-5c2c734f9a3c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncmVlbmhvdXNlJTIwYWdyaWN1bHR1cmUlMjB0ZWNobm9sb2d5fGVufDF8fHx8MTc2OTk1MjYwN3ww&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Network, 
      key: 'project10', 
      color: '#035938',
      image: 'https://images.unsplash.com/photo-1703113690885-8caf0c77a7cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxuZXR3b3JrJTIwdGVjaG5vbG9neSUyMGNvbm5lY3Rpb258ZW58MXx8fHwxNzY5OTUzMjE1fDA&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Droplets, 
      key: 'project11', 
      color: '#52BC88',
      image: 'https://images.unsplash.com/photo-1598370006836-0ae5f7ec61c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpcnJpZ2F0aW9uJTIwc3lzdGVtJTIwZmFybSUyMHdhdGVyfGVufDF8fHx8MTc2OTk1MjYxMXww&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: TreePine, 
      key: 'project12', 
      color: '#F1BC28',
      image: 'https://images.unsplash.com/photo-1641975156937-9ed56d1a426f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmVlJTIwZm9yZXN0JTIwbmF0dXJlfGVufDF8fHx8MTc2OTk1MzIxNnww&ixlib=rb-4.1.0&q=80&w=1080',
    },
    { 
      icon: Package, 
      key: 'project13', 
      color: '#035938',
      image: 'https://images.unsplash.com/photo-1760804876422-7efb73b58048?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwYWNrYWdpbmclMjBib3glMjBwcm9kdWN0fGVufDF8fHx8MTc2OTk1MzIxNXww&ixlib=rb-4.1.0&q=80&w=1080',
    },
  ];
  ...
  return (
    <div className="relative overflow-hidden py-20 bg-gradient-to-b from-white via-[#F9F7EF]/30 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        {/* Section Header */}
        <div className="text-center mb-16" style={{ animation: 'float 6s ease-in-out infinite' }}>
        ...
        <div className="mb-20">
          <div className="flex items-center justify-between mb-12">
            ...
            <div className="hidden md:flex items-center gap-3 px-5 py-2.5 bg-gradient-to-r from-[#52BC88]/10 to-[#F1BC28]/10 rounded-full border border-[#52BC88]/20">
              ...
              <span className="text-sm font-bold text-[#035938]">{keyProjects.length} {t('projects')}</span>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="relative flex items-center gap-6 py-8 transition-all duration-300">
                    ...
                    <div 
                      ...
                      style={{
                        backgroundColor: isHovered ? `${project.color}05` : 'transparent',
            ...
            <div className="space-y-12">
              {feasibilityPoints.map((point, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`flex ${isLeft ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-8`}>
                      {/* Left/Right Content */}
                    ...
                    {isLeft ? (
                      <div className="hidden md:block absolute left-1/2 top-10 w-16 h-0.5"
                        style={{
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    >
                      <Icon className="w-7 h-7" style={{ color: objective.color }} />
                    </div>
              ...
              <div className="bg-gradient-to-br from-white via-[#F9F7EF] to-white rounded-3xl p-10 md:p-12 border border-[#035938]/20 shadow-xl overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start gap-4 mb-8">
                    ...
                    <div>
                      <div className="text-sm font-bold text-[#035938]/60 uppercase tracking-wider mb-2">1</div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-8">
                    <div className="bg-white rounded-2xl p-6 border border-[#035938]/10 shadow-md">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <div className="text-3xl font-bold text-[#035938]">12</div>
                          <div className="text-sm text-[#035938]/60">{t('activity1Fields')}</div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-white rounded-2xl p-6 border border-[#52BC88]/10 shadow-md">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <div className="text-3xl font-bold text-[#52BC88]">120</div>
                          <div className="text-sm text-[#035938]/60">{t('activity1Farmers')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-[#035938] to-[#035938]/90 rounded-2xl p-8">
                    <p className="text-white/90 mb-4">{t('activity1Sessions')}</p>
              ...
              <div className="bg-gradient-to-br from-white via-[#F9F7EF] to-white rounded-3xl p-10 md:p-12 border border-[#52BC88]/20 shadow-xl overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-8">
                    ...
                    <div>
                      <div className="text-sm font-bold text-[#52BC88]/60 uppercase tracking-wider mb-2">2</div>
                      <h4 className="text-2xl md:text-3xl font-bold text-[#035938] mb-3">
                        {t('activity2Title')}
                      </h4>
                  ...
                  <div className="bg-white rounded-2xl p-6 border border-[#52BC88]/10 shadow-md mb-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <div className="text-3xl font-bold text-[#52BC88]">6</div>
                        <div className="text-sm text-[#035938]/60">{t('activity2Containers')}</div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-white via-[#F9F7EF] to-white rounded-3xl p-10 md:p-12 border border-[#F1BC28]/20 shadow-xl overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="text-sm font-bold text-[#F1BC28]/60 uppercase tracking-wider mb-2">3</div>
                      <h4 className="text-2xl md:text-3xl font-bold text-[#035938] mb-3">
                        {t('activity3Title')}
                      </h4>
                      <p className="text-lg text-[#035938]/70 leading-relaxed">
              ...
              <div className="bg-gradient-to-br from-white via-[#F9F7EF] to-white rounded-3xl p-10 md:p-12 border border-[#035938]/20 shadow-xl overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-8">
                    ...
                    <div>
                      <div className="text-sm font-bold text-[#035938]/60 uppercase tracking-wider mb-2">4</div>
                      <h4 className="text-2xl md:text-3xl font-bold text-[#035938] mb-3">
                        {t('activity4Title')}
                      </h4>
                      <p className="text-lg text-[#035938]/70 leading-relaxed mb-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-gradient-to-br from-[#035938]/10 to-transparent rounded-2xl p-6 border border-[#035938]/20">
                      <div className="text-sm font-semibold text-[#035938]/60 uppercase mb-2">Suitable Area</div>
                      <div className="text-3xl font-bold text-[#035938] mb-1">621</div>
                    ...
                    <div className="bg-gradient-to-br from-[#52BC88]/10 to-transparent rounded-2xl p-6 border border-[#52BC88]/20">
                      <div className="text-sm font-semibold text-[#035938]/60 uppercase mb-2">Currently Cultivated</div>
                      <div className="text-3xl font-bold text-[#52BC88] mb-1">346</div>
                      <div className="text-sm text-[#035938]/60">hectares</div>
                    </div>
                    <div className="bg-gradient-to-br from-[#F1BC28]/10 to-transparent rounded-2xl p-6 border border-[#F1BC28]/20">
                      <div className="text-sm font-semibold text-[#035938]/60 uppercase mb-2">Expansion Potential</div>
                      <div className="text-3xl font-bold text-[#F1BC28] mb-1">275</div>
                      <div className="text-sm text-[#035938]/60">hectares</div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-white via-[#F9F7EF] to-white rounded-3xl p-10 md:p-12 border border-[#52BC88]/20 shadow-xl overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-8">
                    ...
                    <div>
                      <div className="text-sm font-bold text-[#52BC88]/60 uppercase tracking-wider mb-2">5</div>
                      <h4 className="text-2xl md:text-3xl font-bold text-[#035938] mb-3">
                        {t('activity5Title')}
                      </h4>
                      <p className="text-lg text-[#035938]/70 leading-relaxed mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-white rounded-2xl p-6 border border-[#52BC88]/10 shadow-md">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <div className="text-3xl font-bold text-[#52BC88]">35</div>
                          <div className="text-sm text-[#035938]/60">{t('activity5FieldVisits')}</div>
                        </div>
                      </div>
                    </div>
                    <div className="bg-white rounded-2xl p-6 border border-[#F1BC28]/10 shadow-md">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          <div className="text-3xl font-bold text-[#F1BC28]">149</div>
                          <div className="text-sm text-[#035938]/60">{t('activity5TrainedFarmers')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-6">
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[#52BC88] flex-shrink-0 mt-0.5"/>
                      <p className="text-[#035938]/70">{t('activity5Visits')}</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[#52BC88] flex-shrink-0 mt-0.5"/>
                      <p className="text-[#035938]/70">{t('activity5Training')}</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[#52BC88] flex-shrink-0 mt-0.5"/>
                      <p className="text-[#035938]/70">{t('activity5Jasmine')}</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-[#52BC88] flex-shrink-0 mt-0.5"/>
                      <p className="text-[#035938]/70">{t('activity5Monitoring')}</p>
                    </div>
                  </div>

                  {/* Impact Statement */}
                  <div className="bg-gradient-to-br from-[#52BC88] to-[#52BC88]/90 rounded-2xl p-6">
                    <p className="text-white/95 font-semibold">{t('activity5Impact')}</p>
                  </div>
                </div>
              </div>
            </div>
