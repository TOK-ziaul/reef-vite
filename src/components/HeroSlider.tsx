...
const HERO_SLIDES = [
  {
    ...
    desc: "hero1Desc",
    buttons: [
      { text: "hero1Btn1", primary: false, page: "photoVideo" },
      { text: "hero1Btn2", primary: true, page: "home", hash: "key-numbers" },
    ],
  },
  {
    image:
    ...
    desc: "hero2Desc",
    buttons: [
      { text: "hero2Btn1", primary: false, page: "sector", sectorId: "coffee" },
      { text: "hero2Btn2", primary: true, page: "about", hash: "achievements" },
    ],
  },
  {
    image:
    ...
    title: "hero3Title",
    desc: "hero3Desc",
    buttons: [{ text: "hero3Btn", primary: true, page: "sustainability" }],
  },
  {
    image:
    ...
    desc: "hero4Desc",
    buttons: [
      { text: "hero4Btn1", primary: false, page: "supportApplication" },
      { text: "hero4Btn2", primary: true, page: "beneficiariesGuide" },
    ],
  },
  {
    image:
    ...
    desc: "hero5Desc",
    buttons: [
      { text: "hero5Btn1", primary: false, page: "about", hash: "achievements" },
      { text: "hero5Btn2", primary: true, page: "home", hash: "interactive-map" },
    ],
  },
...
export function HeroSlider() {
  ...
  useEffect(() => {
    ...
    // Fade out current content — animate buttons individually, not the wrapper
    const elements = [titleRef.current, descRef.current, badgeRef.current].filter(
      Boolean,
    );
  ...
  const handleCtaClick = (button: HeroButton) => {
    navigateTo(button.page, button.sectorId, button.hash);
  };

  const activeSlide = HERO_SLIDES[currentSlide];

  const highlightedTitle = buildHighlightedTitle(
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full">
        ...
        {/* Single content layer — avoids ref/GSAP conflicts on the last slide */}
        <div className="absolute inset-0 z-20 flex items-center pointer-events-none">
          ...
          >
            <div
              ref={contentRef}
              className={`pointer-events-auto ${language === "ar" ? "text-right ml-auto mr-0" : "text-left mr-auto ml-0"}`}
            ...
            >
              ...
              <div ref={buttonsRef} className="flex gap-3 flex-wrap">
                {activeSlide.buttons.map((button, btnIndex) => (
                  <button
                    key={`${currentSlide}-${btnIndex}`}
                    type="button"
