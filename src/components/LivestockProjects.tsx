...
export function LivestockProjects() {
  ...
  const locations = language === 'ar' 
    ? ['الجبيل', 'المدينة المنورة', 'حفر الباطن', 'نجران', 'حائل', 'القصيم', 'عرعر']
    : ['Jubail', 'Madinah', 'Hafr Al-Batin', 'Najran', 'Hail', 'Qassim', 'Arar'];

  const technicalBenefits = language === 'ar' 
    ? [
    ...
    <div className="py-20 bg-[#F9F7EF] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          >
            {language === 'ar' ? 'مشاريع قطاع الماشية' : 'Livestock Sector Projects'}
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12 max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10 text-center" dir={language === 'ar' ? 'rtl' : 'ltr'}>
              <Building2 className="w-10 h-10 text-[#F1BC28] mb-2 mx-auto" strokeWidth={2} />
              <div className="text-5xl font-bold text-white mb-1">8</div>
              <p className="text-lg text-white/90" style={{ fontFamily: language === 'ar' ? "'Loew Next Arabic', sans-serif" : "inherit" }}>
          ...
          >
            ...
            <div className="relative z-10 text-center" dir={language === 'ar' ? 'rtl' : 'ltr'}>
              <div className="flex items-baseline justify-center gap-2 mb-1">
                <span className="text-5xl font-bold text-white">125.1</span>
                <span className="text-lg text-white/90">{language === 'ar' ? 'مليون ر.س' : 'Million SAR'}</span>
              </div>
              <p className="text-lg text-white/90" style={{ fontFamily: language === 'ar' ? "'Loew Next Arabic', sans-serif" : "inherit" }}>
          ...
          <div className="bg-gradient-to-br from-white/80 to-[#F9F7EF] backdrop-blur-sm rounded-3xl p-8 md:p-10 border border-[#035938]/10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
              {locations.map((location, index) => (
                ...
                >
                  <MapPin className="w-10 h-10 text-white mb-3 mx-auto" strokeWidth={2.5} />
                  <p 
            ...
            >
              <div className="flex items-center gap-4" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                <Database className="w-12 h-12 text-[#52BC88] flex-shrink-0" strokeWidth={2} />
                <p 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {technicalBenefits.map((benefit, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.05 }}
              >
                <div className={`relative bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 ${language === 'ar' ? 'pr-20' : 'pl-20'}`}>
                  {/* Number Badge */}
                  <div className={`absolute ${language === 'ar' ? 'right-6' : 'left-6'} top-6`}>
                  ...
                  {/* Decorative Corner */}
                  <div className={`absolute ${language === 'ar' ? 'bottom-0 left-0' : 'bottom-0 right-0'} w-24 h-24 opacity-5 group-hover:opacity-10 transition-opacity`}>
                    <div 
          ...
          <div className="bg-gradient-to-br from-white/80 to-[#F9F7EF] backdrop-blur-sm rounded-3xl p-8 md:p-10 border border-[#035938]/10">
            ...
            <div className="space-y-6">
              {goals.map((goal, index) => (
                ...
                >
                  <div className="flex gap-4 items-start" dir={language === 'ar' ? 'rtl' : 'ltr'}>
