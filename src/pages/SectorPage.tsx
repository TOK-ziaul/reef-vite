...
import { BeekeepingStatsSection } from "../components/BeekeepingStatsSection";
import {
  Lightbulb,
  Cog,
  Sprout,
            ...
            <div className="mb-20 relative">
              ...
              <div className="relative max-w-6xl mx-auto">
                ...
                >
                  ...
                  {/* Objective 3 (numbered 4 in approved content) */}
                  <div className="group relative">
                    <div className="flex items-start gap-4 p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-[#52BC88]/20 hover:border-[#52BC88]/40 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#035938] to-[#52BC88] flex items-center justify-center text-white font-bold shadow-lg">
                        4
              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 mb-8">
                  ...
                  <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 mb-8 mt-8">
                    ...
                    <div className="bg-white rounded-2xl p-6 md:p-8 shadow-md border-l-4 border-[#52BC88]">
                      <p className="text-lg text-gray-700 leading-relaxed">
                        {t("honeyKeyWorksTrainingClosing")}
                      </p>
                    </div>
                  </div>

                  {/* Participation in Agricultural Forums */}
                  <div className="bg-gradient-to-br from-[#035938] to-[#52BC88] rounded-3xl p-8 md:p-12 text-white shadow-xl mb-12 mt-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <button
                      ...
                      className="bg-gradient-to-r from-[#035938] to-[#52BC88] text-white px-8 py-4 rounded-xl font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-2 group"
                    >
                      <svg
                        className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300"
                        fill="none"
                    ...
                    <button
                      type="button"
                      onClick={() => navigateTo("supportApplication")}
                      className="bg-[#F1BC28] text-white px-8 py-4 rounded-xl font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-2 group"
                    >
                      <svg
                        className="w-5 h-5 group-hover:scale-110 transition-transform duration-300"
                        fill="none"
